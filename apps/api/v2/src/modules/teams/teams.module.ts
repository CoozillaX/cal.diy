...
import { TeamMembershipsController } from "@/modules/teams/controllers/team-memberships.controller";
...
@Module({
  ...
  controllers: [TeamsController, TeamMembershipsController, TeamsEventTypesController],
  providers: [
    TeamsRepository,
  ...
  exports: [TeamsRepository, TeamsEventTypesRepository, TeamsEventTypesService, TeamsManagementService],
})
