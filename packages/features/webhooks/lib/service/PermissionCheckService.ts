 ...
 * (see agents/rules/architecture-circular-dependencies.md). "webhook.*" isn't part of the
 * curated team-permission catalog, so no catalog-override branch is needed here.
 */
